                ...
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="car-img">
                                <img src="{{ url('images/car1.png') }}" class="img-responsive" alt="car1">
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="car-img">
                                <img src="{{ url('images/car2.png') }}" class="img-responsive" alt="car1">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="styled-select-car">
                            <select name="car-select" id="car-select">
                                ...
                                @foreach($data as $s_data)
                                    <option value="{{ $s_data->id }}" the_image="{{ url('images/'.$s_data->image) }}">{{ $s_data->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <!-- Car select end -->
...
<section id="vehicles" class="container">
    <div class="row">
        ...
        <div class="col-md-3 vehicle-nav-row wow fadeInUp" data-wow-offset="100">
            <div id="vehicle-nav-container">
                <ul class="vehicle-nav">
                    @foreach($data as $s_data)
                        <li class="{{ $loop->first ? 'active' : ''}}"><a href="#vehicle-{{ $loop->index + 1 }}">{{ $s_data->name }}</a><span class="active">&nbsp;</span></li>
                    @endforeach
                </ul>
            </div>
        ...
        @foreach($data as $s_data)
            <!-- Vehicle {{ $loop->index + 1 }} data start -->
                <div class="vehicle-data" id="vehicle-{{ $loop->index + 1 }}">
                    <div class="col-md-6 wow fadeIn" data-wow-offset="100">
                        <div class="vehicle-img">
                            <img class="img-responsive" src="{{ url('images/'.$s_data->image) }}" alt="Vehicle">
                        </div>
                    </div>
                    <div class="col-md-3 wow fadeInUp" data-wow-offset="200">
                        <div class="vehicle-price">$ {{ $s_data->price }} <span class="info">rent per day</span></div>
                        <table class="table vehicle-features">
                            ...
                            <tr>
                                <td>Luggage</td>
                                <td>{{ $s_data->suitcases }} Suitcases / {{ $s_data->bags }} Bags</td>
                            </tr>
                            <tr>
                                <td>Transmission</td>
                                <td>{{ $s_data->transmition }}</td>
                            </tr>
                            <tr>
                                <td>Air conditioning</td>
                                <td>{{ $s_data->air_condition = 1 ? 'yes' : 'no' }}</td>
                            </tr>
                            <tr>
                                <td>Minimum age</td>
                                <td>{{ $s_data->min_age }} years</td>
                            </tr>
                        </table>
                        <a href="#teaser" class="reserve-button scroll-to"><span class="glyphicon glyphicon-calendar"></span> Reserve now</a>
                    </div>
                </div>
            <!-- Vehicle {{ $loop->index + 1 }} data end -->
        @endforeach
...
<section id="information" class="container">
    ...
    <div class="row wow fadeInLeft" data-wow-offset="100">
        <div class="col-md-6 col-xs-12 pull-right">
            <img src="{{ url('images/info-img.jpg') }}" alt="Info Img" class="img-responsive">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-xs-12 pull-right">
            ...
            <div class="contact-box">
                <img src="{{ url('images/contact-box-img1.jpg') }}" alt="contact-img">
            ...
            <div class="contact-box">
                <img src="{{ url('images/contact-box-img2.jpg') }}" alt="contact-img">
            ...
            <div class="contact-box">
                <img src="{{ url('images/contact-box-img3.jpg') }}" alt="contact-img">
