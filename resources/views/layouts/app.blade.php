...
<header data-spy="affix" data-offset-top="39" data-offset-bottom="0" class="large">
    ...
    <div class="row container box">
        <div class="col-md-5">
            <!-- Logo start -->
            <div class="brand">
                <h1><a class="scroll-to" href="#top"><img class="img-responsive" src="{{ url('images/logo.gif') }}" alt="Car|Rental"></a></h1>
            </div>
            <!-- Logo end -->
        </div>
                    ...
                    <div class="checkout-vehicle-info">
                        ...
                        <div class="vehicle-info">
                            ...
                            <div class="vehicle-image">
                                <img class="img-responsive" id="selected-vehicle-image" src="{{ url('images/vehicle1.jpg') }}" alt="Vehicle">
                            </div>
                        </div>
